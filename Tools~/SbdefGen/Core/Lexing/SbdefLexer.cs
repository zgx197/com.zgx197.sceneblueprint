...
namespace SbdefGen.Core.Lexing;

internal enum TokenKind
{
    Action, Port, Flow, InFlow, Marker, Label, Gizmo, Min, Max,
    Extends, Annotation, EditorTool, Enum, Field, Signal,
    TagDimension, CodeGen,
        ...
        while (i < source.Length)
        {
            ...
            if (char.IsLetter(c) || c == '_')
            {
                ...
                var kind = word switch
                {
                    ...
                    "tagdimension" => TokenKind.TagDimension,
